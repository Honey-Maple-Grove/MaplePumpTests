...
// 
/*
    Name:       SDUploadToClient.ino
    Created:	6/18/2019 2:47:20 PM
...
//* Arduino Ethernet WebServer exampleand the rest is from Limor Fried
...
void setup() {
  ...
  digitalWrite(WIZ_CS, HIGH);  // but turn off the W5500 chip for now  
	root = SD.open("/");
